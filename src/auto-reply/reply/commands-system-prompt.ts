...
import { buildAgentSystemPrompt, buildConfigDisciplineText } from "../../agents/system-prompt.js";
...
export async function resolveCommandsSystemPromptBundle(
  ...
  const systemPrompt = buildAgentSystemPrompt({
    ...
    extraSystemPrompt: buildConfigDisciplineText(params.cfg, sessionAgentId),
